...
from dfs_transformer import EarlyStopping, DFSCodeVariationalAutoencoder, Deepchem2TorchGeometric, FeaturesDataset, collate_smiles_minc_rndc_features_y
import argparse
...
parser.add_argument('--n_memory_blocks', type=int, default=1)
...
parser.add_argument('--pretrained_dir', type=str, default="./models/pubchem10M/features_autoencoder/min2min/")
...
model = DFSCodeVariationalAutoencoder(nn.Linear(args.n_node_features, args.emb_dim),
                         nn.Linear(args.n_edge_features, args.emb_dim),
                         n_memory_blocks=args.n_memory_blocks,
