...
if __name__ == "__main__":
    ...
    parser.add_argument('--wandb_project', type=str, default="pubchem_tests_before_release")
    ...
    parser.add_argument('--loops', dest='loops', action='store_true', help='add self loops to the graph')
    parser.add_argument('--no_features', dest='no_features', action='store_true', help='turns off input features (vertex and edge features)')
    parser.add_argument('--no_properties', dest='no_properties', action='store_true', help='turns off the pretraining term based on molecular properties precomputed with rdkit')
    ...
    config.training["no_properties"] = args.no_properties
